        ...
        svg.selectAll("dot")
            ...
            .on("mouseover", function (d) {
                button.transition()
                    ...
                    .style("cursor", "pointer")
                    .style("opacity", 1);
                button.html("<h3>" + d.key + "</h3>" + "<a href=''><h4 style='float:right'>x Fechar</h4></a>" + "<br/>" + "<h4>Ano: </h4>" + FormatDate(d.date) + "<br/>" + "<h4>Taxa de rejeição: </h4> " + d.value + "%<br/>" + "<hr/>" + "<h4>Total de vistos concedidos: </h4>" + d.vistos + "<br/>" + "<h4>Turismo/Negócios: </h4>" + d.v_pct + "<br/>" + "<h4>Trabalho/Estudos: </h4>" + d.t_pct + "<br/>" + "<h4>Outros tipos: </h4>" + d.o_pct)
